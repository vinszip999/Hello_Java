...
//		<기본형 타입 변환>
//		형변환이란, 변수 또는 리터럴(값)의 타입을 다른 타입으로 변환하는 것이다.
//
//		byte < short, char < int < long < float < double
//
//		작은 데이터 -> 큰 데이터에 담는 것 가능. 
//
//		>묵시적 형변환
//		- 크기가 작은 데이터 타입을 크기가 더 큰 타입으로 바꿀 때에는 묵시적으로 형을 바꾸어 준다.
//		- 다른 이름으로 "암묵적 형변환" 이라고도 부른다.
//
//		>명시적 형변환
//		- 크기가 더 큰 타입을 작은 타입으로 바꿀 때에는 명시적으로 변환 해주어야 한다.
//		- 다른 이름으로 "강제 형변환" 이라고도 부른다.
...
//		  - =과 +는 연산자이다. (=은 대입연산자 이고, +는 산술연산자)
//		  - y와 z는 피연산자이다.
//		  - x = y+ z 는 연산식이다.
//		- 부호를 결정하는 부호연산자
//		- 산술 연산을 할 수 있는 산술연산자
//		- 1씩 증가하거나 감소시키는 증감연산자
//		- 피연산자가 1개인 연산자는 단항연산자
//		  - 부호 연산자와, 증감연산자는 단항연산자이다.
		  
		
//		<비교연산자>
//		== , != , < , > , <= , >= 표현할 수 있는 연산자.
//
//		- 비교 연산자의 결과는 boolean 값이다.
//		- *단순 대입 연산자*
//		  - i = 10
